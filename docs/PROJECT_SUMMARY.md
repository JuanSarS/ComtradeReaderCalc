...
### For Implementation:
1. Start with `Src/core/analysis/comtrade_reader.py`
...
4. Explore class structures in Src/core/analysis/
5. Study GUI integration in (legacy)

### For Extension:
1. Add new analysis methods in Src/core/analysis/
2. Add new visualization tabs in (legacy)tabs/
