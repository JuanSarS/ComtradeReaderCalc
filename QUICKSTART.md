...
1. Click **"Load COMTRADE File (.cfg)"** button
2. Navigate to a .cfg file
3. Select and open it

The application will read both .cfg and .dat files.
...
├────────────────────────────────────────────────────┤
│ [Load COMTRADE File] | Loaded: filename.cfg        │
├────────────────────────────────────────────────────┤
│ ┌────────────────────────────────────────────────┐ │
│ │ Tabs: Instantaneous | RMS | Phasors | ...     │ │
│ │                                                │ │
│ │  [Tab Content Area]                           │ │
│ │                                                │ │
│ │                                                │ │
...
2. Core algorithms are in `src/core/`
3. GUI components are in `src/gui/`
